...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 0.1.1 | 0.1.5 | 0.5.4 | 0.1.4 | H1/1 | H2/2 | 2026-09-16 (READMEs only, smoke tests pending) | README consistency pass (symlink option, version line, templates listing, copy-paste fix) — same contracts |
